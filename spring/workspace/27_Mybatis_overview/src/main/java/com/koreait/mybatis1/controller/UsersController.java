...
public class UsersController {
	...
	// Mybatis를 사용하는 경우에는 Sqlsession을 사용합니다.
	...
	/*
		...
		UsersDao의 특정 메소드를 호출하면 연결된 mapper(users.xml)의 쿼리가 실행됩니다.
	*/
	...
	/*
		...
		public String usersInsert1(@RequestParam("name") String name, @RequestParam("phone") String phone) {
			UsersDao usersDao = sqlSession.getMapper(UsersDao.class);
	...
	*/
	...
	public String usersViewPage(@RequestParam("no") int no, Model model) {
		UsersDao usersDao = sqlSession.getMapper(UsersDao.class);
