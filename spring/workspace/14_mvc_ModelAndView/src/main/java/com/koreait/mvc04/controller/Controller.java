...
public class Controller {
	...
	/*
		ModelAndView 클래스
		1. 스프링 2 이전에 사용하던 클래스로 (아마도) 현재 많이 생산되어있는 코드이다.
		...
		4. Model은 request라고 생각하시면 편합니다.
			- 모델은 컨트롤러가 JSP에게 전달하고자 하는 데이터를 속성으로 저장하는 클래스입니다.
	...
	*/
	...
	// 1. 단순 이동
	@RequestMapping("v01")	// Mapping과 이동경로가 달라도 상관이 전혀 없다.
	...
	// 지금까지 JSP로 이동하는 방식은
	// 100% forward 였습니다. Redirect 하는 방법은 나중에 다루게 됩니다.
	
	// forward이기 때문에 JSP로 ㅏ데이터를 보낼 수 있습니다.
	@RequestMapping("v02")
