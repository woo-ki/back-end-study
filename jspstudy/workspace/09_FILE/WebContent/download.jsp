...
<%
	...
	// File file = new File(realPath, filename);	// realPath + "/" + filename
	File file = new File(realPath, filename);
	
	// 3. (이건다운로드다)라는 헤더 타입을 만든다.
	...
	try {	// JSP에서 OutputStream을 사용하려면
		...
		// 읽은 내용을 array 배열의 0번 인덱스부터 길이만큼 영역에 저장해라.
		// (int)file.length() -> 길이가 10이라면
		// bis.read(array, 0, 10) : array배열의 0번 인덱스부터 10개 공간 사용해서 저장해
