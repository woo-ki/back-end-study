...
public class Ex01_String {
	...
	public static void main(String[] args) {
		...
		// substring(시작인덱스, 종료인덱스): 시작 <= < 종료 영역을 추출
		System.out.println("apple의 첫 3글자는 " + a.substring(0, 3) + "이다.");
		
		// 7. 특정 문자(문자열)의 인덱스를 반환하는 indexOf 메소드가 있다.
		// 발견된 첫 번째 문자(문자열)의 인덱스가 반환된다.
		String str = "best of best of best";
		System.out.println("첫번째 best 인덱스: " + str.indexOf("best"));
		System.out.println("두번째 best 인덱스: " + str.indexOf("best", 5));	// 시작인덱스: 1~8 모두 가능
		// 첫번째 best가 언제 나오는지 모르는 상황이라면: 첫번째 best 인덱스 다음부터 검색
		System.out.println("첫번째 best 인덱스: " + str.indexOf("best", str.indexOf("best") + 1));
		
		// 8. 거꾸로 찾는 lastIndexOf 메소드가 있다.
		System.out.println("마지막 best의 인덱스: " + str.lastIndexOf("best"));
		
		// 9. 문자열의 앞뒤의 white space(공백 문자)를 제거하는 trim 메소드가 있다.
		String name = "   james ";
		...
		System.out.println(n.toString().equals("10"));	// 객체n은 String이 되었기 떄문에 String의 메소드를 호출할 수 있다.
