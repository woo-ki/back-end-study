 ...
 * 2. 객체를 스트림으로 입출력 처리하려면 해당 객체를 직렬화 해야한다.
 * 3. 직렬화 하려면 Serializable 인터페이스를 구현하면 된다.
 */

class User implements Serializable {

	/**
	 * serailVersionUID 값은 랜덤합니다.
	 */
...
public class Ex09_ObjectOutputStream {
	...
	public static void main(String[] args) {
		...
		try {
			...
			User user2 = new User("5678", 2000);
			User user3 = new User("4321", 3000);
			
			// user.dat파일로 객체 보내기
			// 따로 보내거나, 합쳐서 한 번에 보낸다.
